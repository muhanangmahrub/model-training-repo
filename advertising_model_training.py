...
bucket = storage_client.bucket("anang-mlops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "mlops-project-444315.ml_ops.advertising_roi_model_metrics"
...
def main():
    ...
    campaign_file_path = "gs://anang-mlops/advertising_roi/campaign_spend.csv"
    # campaign_file_path = "data/campaign_spend.csv"
    df_spend = read_campaign_data(campaign_file_path)

    revenue_file_path = "gs://anang-mlops/advertising_roi/monthly_revenue.csv"
    # revenue_file_path = "data/monthly_revenue.csv"
